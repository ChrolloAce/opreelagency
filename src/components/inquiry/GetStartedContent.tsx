          ...
          <div className="w-full max-w-4xl animate-in fade-in slide-in-from-bottom-8 duration-500">
            ...
            <div className="grid md:grid-cols-2 gap-6 md:gap-8 px-4">
              ...
              <button 
                ...
                className="group relative flex flex-col items-center p-10 rounded-[32px] bg-black/40 backdrop-blur-2xl border border-white/10 hover:bg-black/50 hover:border-blue-500/50 hover:shadow-[0_0_40px_rgba(59,130,246,0.2)] transition-all duration-300 text-center"
              >
                <div className="h-20 w-20 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300">
                ...
                <h3 className="text-2xl font-bold text-white mb-3">Book Strategy Call</h3>
                <p className="text-slate-400 leading-relaxed group-hover:text-slate-300 transition-colors">
                  Tell us about your goals and we'll build a custom content strategy for you.
                </p>
                <div className="mt-8 px-6 py-2 rounded-full border border-white/20 text-white text-sm font-bold group-hover:bg-blue-600 group-hover:border-blue-600 transition-all">
                  Start Inquiry →
                </div>
              </button>
              ...
              <Link 
                href="/order"
                className="group relative flex flex-col items-center p-10 rounded-[32px] bg-black/40 backdrop-blur-2xl border border-white/10 hover:bg-black/50 hover:border-emerald-500/50 hover:shadow-[0_0_40px_rgba(16,185,129,0.2)] transition-all duration-300 text-center"
              >
                <div className="h-20 w-20 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-10 h-10 text-white">
                ...
                <h3 className="text-2xl font-bold text-white mb-3">Buy Videos Directly</h3>
                <p className="text-slate-400 leading-relaxed group-hover:text-slate-300 transition-colors">
                  Skip the talk. Select your volume, provide details, and get content fast.
                </p>
                <div className="mt-8 px-6 py-2 rounded-full border border-white/20 text-white text-sm font-bold group-hover:bg-emerald-600 group-hover:border-emerald-600 transition-all">
                  Order Now →
                </div>
              </Link>
            </div>
